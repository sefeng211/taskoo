    ...
    for option in options.iter() {
        if option.starts_with("s:") {
            ...
            if parse_remove_tag_names {
               command_option.remove_tag_names.push(option[1..].to_string());
            } else {
...
mod tests {
    ...
    fn test_parse_schedule_at_ok() {
        ...
        let parsed_option = parse_command_option(&option, false, false).unwrap();
    ...
    fn test_parse_body() {
        ...
        let parsed_option = parse_command_option(&option, true, false).unwrap();
    ...
    fn test_parse_remove_tag_names() {
        ...
        let parsed_option = parse_command_option(&option, true, true).unwrap();
